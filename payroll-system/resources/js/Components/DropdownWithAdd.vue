  ...
  <div class="mb-4">
    ...
    <div class="relative mt-1 flex gap-2">
      ...
      <button
        ...
        @click="$emit('add')"
        :disabled="loading"
        class="inline-flex items-center justify-center py-2 px-3 border border-transparent text-sm leading-4 font-medium rounded-full text-white bg-blue-900 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 whitespace-nowrap min-w-[2.5rem]"
      >
        <span v-if="loading">
          <svg
