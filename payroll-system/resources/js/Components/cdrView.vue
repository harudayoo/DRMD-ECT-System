<template>
    <div class="relative -mt-1">
        ...
        <button
            ...
            class="py-1.5 px-4 flex items-center rounded-xl bg-blue-900 hover:bg-blue-700 text-slate-100 hover:text-slate-300"
        >
            ← Back to CDR List
        </button>
        ...
        <div class="mb-6 mt-1">
            ...
            <div v-if="!selectedCdr" class="w-full">
                <label for="search" class="sr-only">Search CDRs</label>
                <div class="relative mt-3 left-[60%]">
                    <input
                        id="search"
                        v-model="search"
                        ...
                        class="bg-white text-gray-700 rounded-full pl-10 pr-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 w-[40%] h-9"
                    />
                    <div
        ...
        <div v-if="selectedCdr" class="-mt-4">
            ...
            <div class="grid grid-cols-4 gap-4 mb-6">
                ...
                <div class="relative">
                    ...
                    <select
                        ...
                        :disabled="
                            !selectedCdr ||
                            isFieldFilled('entityNameFundCluster')
                        "
                    >
                        <option value="">
                ...
                <div class="relative">
                    ...
                    <select
                        ...
                        :disabled="
                            !selectedCdr ||
                            isFieldFilled('officerDesignationStation')
                        "
                    >
                        <option value="">
                ...
                <div class="relative">
                    ...
                    <select
                        ...
                        class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-full"
                        :disabled="
                            !selectedCdr || isFieldFilled('referenceNumber')
                        "
                    >
                    ...
                    <p
                        v-if="isFieldFilled('referenceNumber')"
                        class="mt-1 text-sm text-green-600"
                    >
                        This field has been filled and saved
                    </p>
                ...
                <div class="relative">
                    ...
                    <select
                        ...
                        class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-full"
                        :disabled="
                            !selectedCdr || isFieldFilled('natureOfPayment')
                        "
                    >
                    ...
                    <p
                        v-if="isFieldFilled('natureOfPayment')"
                        class="mt-1 text-sm text-green-600"
                    >
                        This field has been filled and saved
                    </p>
                ...
                <div class="relative">
                    ...
                    <input
                        ...
                        class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-full"
                        :disabled="
                            !selectedCdr || isFieldFilled('cashAdvanceReceived')
                        "
            ...
            <div class="flex justify-end mb-5 -mt-16 space-x-4">
                <!-- Insert Data Button -->
                <button
                    @click="insertData"
                    class="px-4 py-1.5 bg-blue-900 text-white rounded-full hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
                ...
                <button
                    ...
                    class="px-4 py-1.5 bg-red-800 text-white rounded-full hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                >
                    Add New Data
                </button>
                ...
                <button
                    ...
                    class="px-4 py-1.5 ml-2 text-white bg-green-700 rounded-full hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
                >
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        >
                            ...
                            <td
                                class="px-6 py-4 whitespace-nowrap text-centertext-sm text-gray-900"
                            >
                            ...
                            >
                                <span
                                    class="px-2 inline-flex text-center text-xs leading-5 font-semibold rounded-full"
                                    :class="{
                ...
                <div class="fixed inset-0 overflow-y-auto">
                    ...
                    >
                        ...
                        >
                            <DialogTitle
                                as="h3"
                                class="text-xl font-medium text-center leading-6 text-gray-900"
                            >
                                Add New Item
                            </DialogTitle>
                            ...
                            <div class="mt-6 flex justify-end space-x-3">
                                <button
                                    @click="closeModal"
                                    class="px-4 py-2 text-base font-medium text-gray-900 bg-gray-300 rounded-md hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
                                >
                                    Cancel
                                </button>
                                <button
                                    @click="saveNewItem"
                                    class="px-4 py-2 text-base font-medium text-white bg-blue-900 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                                >
                                    Save
                                </button>
                            </div>
...
const fetchBeneficiaries = async (payrollId, page = 1, isRetry = false) => {
    ...
    try {
        ...
        if (
            !isRetry &&
            retryAttempts.value.beneficiaries < MAX_RETRY_ATTEMPTS
        ) {
...
const insertData = async () => {
    ...
    try {
        ...
        const response = await axios.put(
            route("cdr.update", selectedCdr.value.cdrID),
            {
                ...
                cashAdvanceReceived: parseFloat(
                    selectedFilters.value.cashAdvanceReceived
                ),
            }
        );
...
const exportPDF = async (cdr) => {
    try {
        ...
        link.href = url;
        link.download = `CDR_${cdr.cdrID}_${
