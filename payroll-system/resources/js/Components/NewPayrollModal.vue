            ...
            <form @submit.prevent="submitPayroll">
                <div class="grid grid-cols-2 gap-4">
                    <div class="col-span-2">
                        <label for="payrollName" class="block mb-2"
                            >Payroll Name</label
                        >
                        <input
                            type="text"
                ...
                <div class="mt-6 flex justify-end space-x-4">
                    ...
                    <button
                        type="submit"
                        class="px-4 py-2 bg-blue-900 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 flex items-center"
                        :disabled="isLoading"
                    >
