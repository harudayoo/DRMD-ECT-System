  ...
  <div>
    ...
    >
      <nav class="mt-5 flex-grow">
        <h3 class="px-6 text-xs font-semibold text-gray-600 uppercase tracking-wide">
          Home
        </h3>
        <a
          href="#"
        ...
        <div class="mt-4">
          ...
          <div class="mt-2">
            ...
            >
              ...
              <svg
                :class="{
                  'transform rotate-180': openSubMenu === 'beneficiaries',
                }"
            ...
            <div v-show="openSubMenu === 'beneficiaries'" class="mt-2 py-2 bg-gray-50">
              <a
                @click="openModal"
                href="#"
              ...
              <a
                href="#"
                @click.prevent="$inertia.visit(route('beneficiaries.edit'))"
                class="block px-6 py-2 text-gray-600 hover:bg-gray-100"
          ...
          <div class="mt-2">
            ...
            >
              ...
              <svg
                :class="{
                  'transform rotate-180': openSubMenu === 'masterlist',
                }"
                class="w-4 h-4 transition-transform duration-200"
                fill="none"
                stroke="currentColor"
            ...
            <div v-show="openSubMenu === 'masterlist'" class="mt-2 py-2 bg-gray-50">
              <a
              ...
              <a
                href="#"
                @click.prevent="$inertia.visit(route('masterlists.view'))"
                class="block px-6 py-2 text-gray-600 hover:bg-gray-100"
                >View Masterlists</a
              >
              <a
          ...
          <div class="mt-2">
            ...
            >
              ...
              <svg
                :class="{
                  'transform rotate-180': openSubMenu === 'documents',
                }"
                class="w-4 h-4 transition-transform duration-200"
                fill="none"
                stroke="currentColor"
            ...
            <div v-show="openSubMenu === 'documents'" class="mt-2 py-2 bg-gray-50">
              <a
                href="#"
                @click.prevent="$inertia.visit(route('payroll.index'))"
                class="block px-6 py-2 text-gray-600 hover:bg-gray-100"
                >Payroll Release</a
              >
              <a
                href="#"
                @click.prevent="$inertia.visit(route('cdr.index'))"
                class="block px-6 py-2 text-gray-600 hover:bg-gray-100"
                >Cash Disbursement Record</a
              >
              <a
                href="#"
                @click.prevent="$inertia.visit(route('rcd.index'))"
                class="block px-6 py-2 text-gray-600 hover:bg-gray-100"
      ...
      <div class="bg-white p-8 rounded-lg shadow-xl w-full max-w-2xl">
        ...
        <form @submit.prevent="addBeneficiary">
          <div class="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                ...
                class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
                <option value="" disabled selected>Select Name Extension</option>
            ...
            <div>
              <label for="masterlist" class="block mb-2">Masterlist</label>
              <select
                id="masterlist"
                ...
                required
              >
                <option value="" disabled selected>Select Masterlist</option>
                <option
          ...
          <div class="mt-6 flex justify-end space-x-4">
            ...
            <button
              type="submit"
              class="px-4 py-2 bg-blue-900 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
              Add Beneficiary
            </button>
          </div>
    ...
    >
      <div class="bg-white p-8 rounded-lg shadow-xl w-full max-w-2xl">
        <h2 class="text-2xl font-bold mb-4 text-center">Similar Beneficiaries Found</h2>
        <ul class="mb-4">
          <li
      ...
      <div class="bg-white p-5 rounded-lg shadow-xl max-w-md w-full">
        ...
        <div v-if="selectedFile" class="mt-4 text-center">
          ...
          <button
            ...
            class="mt-2 px-6 py-2 bg-green-700 text-white rounded-full hover:bg-green-600 disabled:bg-gray-400"
          >
    ...
    >
      <div class="bg-white p-5 rounded-lg shadow-xl flex flex-col items-center">
        <p class="text-lg font-semibold mb-4">Uploading and processing file...</p>
        <div
    ...
    <!-- Similar Beneficiaries Modal -->
    <div
      v-if="showSimilarBeneficiariesModal"
      class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full flex items-center justify-center z-50"
    >
      <div class="bg-white p-8 rounded-md shadow-xl max-w-6xl w-full">
        <h2 class="text-2xl font-bold mb-4">Similar Beneficiaries Found</h2>
        <p class="mb-4">The following similar beneficiaries were found during import:</p>

        <div class="max-h-96 overflow-y-auto">
          <table class="w-full">
            <thead class="bg-gray-50">
              <tr>
                <th class="px-4 py-2 text-left">Imported Data</th>
                <th class="px-4 py-2 text-left">Existing Record</th>
                <th class="px-4 py-2 text-left">Similarity Score</th>
                <th class="px-4 py-2 text-left">Action Taken</th>
              </tr>
            </thead>
            <tbody>
              <tr v-for="match in similarBeneficiaries" :key="match.id" class="border-b">
                <td class="px-4 py-2">
                  <div>
                    {{ match.imported.lastName }},
                    {{ match.imported.firstName }}
                    {{ match.imported.middleName }}
                  </div>
                  <div class="text-sm text-gray-600">
                    DOB: {{ match.imported.dateOfBirth }}
                  </div>
                </td>
                <td class="px-4 py-2">
                  <div>
                    {{ match.existing.lastName }},
                    {{ match.existing.firstName }}
                    {{ match.existing.middleName }}
                  </div>
                  <div class="text-sm text-gray-600">
                    DOB: {{ match.existing.dateOfBirth }}
                  </div>
                </td>
                <td class="px-4 py-2">{{ match.similarityScore }}%</td>
                <td class="px-4 py-2">
                  <span
                    ...
                    "
                  >
                    {{ match.action === "updated" ? "Updated" : "Created New" }}
                  </span>
                </td>
              </tr>
            </tbody>
        ...
        <div class="mt-6 flex justify-end">
          <button
            @click="closeSimilarBeneficiariesModal"
      ...
      <div class="bg-white p-8 rounded-lg shadow-xl max-w-md w-full">
        ...
        <div class="mb-4">
          ...
          <select
            ...
            @change="fetchAddMListMunicipalities"
          >
          ...
          <p v-if="errors.provinceID" class="text-red-500 text-xs italic">
            {{ errors.provinceID }}
          </p>
        </div>
        <div class="mb-4">
          ...
          <select
            ...
            :disabled="!newMasterlist.provinceID"
          >
          ...
          <p v-if="errors.municipalityID" class="text-red-500 text-xs italic">
        ...
        <div class="mb-4">
          ...
          <input
            ...
            :disabled="isLoading"
          />
          <p v-if="errors.masterlistName" class="text-red-500 text-xs italic">
    ...
    >
      <div class="bg-white p-8 rounded-md shadow-xl max-w-md w-full">
        <h2 class="text-2xl font-bold mb-4">Confirm Masterlist Creation</h2>
    ...
    >
      <div class="bg-white p-8 rounded-md shadow-xl max-w-md w-full">
        ...
        <p class="mb-4">New masterlist has been created successfully.</p>
        <button
        ...
        <button
          ...
          class="bg-blue-900 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mb-2 w-full"
        >
          Add New Beneficiary
        </button>
        <button
    ...
    >
      <div class="bg-white p-8 rounded-md shadow-xl max-w-4xl w-full">
        <h2 class="text-2xl font-bold mb-4">Add Existing Beneficiary</h2>
        <input
          v-model="searchQuery"
          type="text"
        ...
        <div class="max-h-96 overflow-y-auto">
          <table class="w-full">
            ...
            <tbody>
              <tr v-for="beneficiary in filteredBeneficiaries" :key="beneficiary.id">
                ...
                <td class="border px-4 py-2">
                  <button
                    @click="addExistingBeneficiary(beneficiary.id)"
                    class="bg-blue-900 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded"
                    :disabled="isLoading"
                  >
...
const showSimilarBeneficiariesModal = ref(false);

// Add these methods
const closeSimilarBeneficiariesModal = () => {
  showSimilarBeneficiariesModal.value = false;
  similarBeneficiaries.value = [];
};
...
const validateName = (field) => {
  beneficiary.value[field] = beneficiary.value[field].replace(/[^A-Za-z ]/g, "");
};
...
const createMasterlist = () => {
  ...
  console.log("Creating masterlist with data:", {
    provinceID: newMasterlist.value.provinceID,
    municipalityID: newMasterlist.value.municipalityID,
    masterlistName: newMasterlist.value.masterlistName,
  });

  // Validate all required fields
  if (!newMasterlist.value.provinceID) {
    errors.value.provinceID = "Province is required";
  }
  if (!newMasterlist.value.municipalityID) {
    errors.value.municipalityID = "Municipality is required";
  }
  if (!newMasterlist.value.masterlistName?.trim()) {
...
const addBeneficiary = async () => {
  try {
    const response = await axios.post(route("beneficiaries.store"), beneficiary.value);
...
const uploadFile = async () => {
  ...
  try {
    const response = await axios.post(route("masterlists.import"), formData, {
      headers: {
    ...
    if (response.data.similarBeneficiaries?.length > 0) {
      similarBeneficiaries.value = response.data.similarBeneficiaries;
      showSimilarBeneficiariesModal.value = true;
...
const confirmCreateMasterlist = async () => {
  isLoading.value = true;
  try {
    console.log("Confirming masterlist creation with data:", newMasterlist.value);

    // Create payload from current values
    const payload = {
      provinceID: newMasterlist.value.provinceID,
      municipalityID: newMasterlist.value.municipalityID,
      masterlistName: newMasterlist.value.masterlistName,
    ...
    const response = await axios.post(route("masterlists.store"), payload);
    ...
    if (error.response?.data?.errors) {
      errors.value = {
        provinceID: error.response.data.errors.provinceID?.[0] || "",
        municipalityID: error.response.data.errors.municipalityID?.[0] || "",
        masterlistName: error.response.data.errors.masterlistName?.[0] || "",
      };
    } else {
      errorAddMListMessage.value = error.message || "Error creating masterlist";
    }
  } finally {
    isLoading.value = false;
  }
...
watch(
  () => newMasterlist.value.provinceID,
  (newValue) => {
    if (newValue) {
      newMasterlist.value.municipalityID = "";
      fetchAddMListMunicipalities();
    }
  }
);

// Add watchers to ensure data persistence between modals
watch(
  () => showAddMListConfirmationModal.value,
  (newVal) => {
    if (!newVal) {
      // If confirmation modal is closed without confirming, don't reset the form
      console.log(
        "Confirmation modal closed, preserving form data:",
        newMasterlist.value
      );
    }
  }
...
watch(
  () => showAddMasterlistModal.value,
  (newVal) => {
    if (!newVal) {
      // Only reset if the main modal is closed and we're not in the confirmation flow
      if (!showAddMListConfirmationModal.value && !showAddMListSuccessModal.value) {
        console.log("Main modal closed, resetting form");
        newMasterlist.value = {
          provinceID: "",
          municipalityID: "",
          masterlistName: "",
...
const closeAddMasterlistModal = () => {
  if (!isLoading.value && !showAddMListConfirmationModal.value) {
    showAddMasterlistModal.value = false;
    // Only reset if we're not in the confirmation flow
    if (!showAddMListConfirmationModal.value) {
      newMasterlist.value = {
        provinceID: "",
        municipalityID: "",
        masterlistName: "",
...
const fetchExistingBeneficiaries = async () => {
  isLoading.value = true;
  try {
    const response = await axios.get(route("masterlists.existing-beneficiaries"), {
...
watch(searchQuery, (newQuery) => {
  if (newQuery) {
    filteredBeneficiaries.value = filteredBeneficiaries.value.filter((beneficiary) =>
