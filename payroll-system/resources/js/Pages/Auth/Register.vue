...
// Validate first name, middle name, last name, and suffix fields
...
// Prevent number input in name fields
const preventNumberInput = (event: InputEvent) => {
