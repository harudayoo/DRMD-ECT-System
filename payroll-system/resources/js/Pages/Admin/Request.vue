    ...
    <div class="flex-1 flex flex-col overflow-hidden p-4">
            ...
            <table class="w-full bg-white">
              ...
              <tbody>
                <tr v-for="request in userRequests" :key="request.id">
                  ...
                  <td class="py-2 px-4 border-b border-gray-200">
                    <button
                      @click="openCreateUserForm(request.email, request.id)"
      ...
      >
        ...
        >
          ...
          >
            <div v-for="field in formFields" :key="field.id" class="flex flex-col">
              <label :for="field.id" class="text-sm font-semibold mb-1">{{
                field.label
              }}</label>
              <div class="relative">
                <input
              ...
              <p v-if="field.error" class="text-red-500 text-xs mt-1">
                {{ field.error }}
              </p>
            </div>
