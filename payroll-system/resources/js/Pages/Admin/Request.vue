                                    ...
                                    >
                                        ...
                                        >
                                            <button
                                                ...
                                                "
                                                class="bg-blue-900 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded mr-2"
                                            >
                                                Create
                                            </button>
                                            <button
                                                @click="confirmDeny(request.id)"
                                                class="bg-red-800 hover:bg-red-600 text-white font-bold py-1 px-2 rounded"
                                            >
                                                Deny
                                            </button>
                                        </td>
                ...
                >
                    <div class="bg-white p-8 rounded-lg shadow-xl">
                        ...
                        <div class="mt-6 flex justify-center space-x-4">
                            ...
                            <button
                                @click="denyRequest"
                                class="bg-red-800 hover:bg-red-600 text-white font-bold py-2 px-4 rounded"
                            >
                                Confirm
                            </button>
                        </div>
