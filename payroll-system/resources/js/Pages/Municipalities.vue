      ...
      <div class="p-4 relative">
        ...
        <ul class="mt-4 ml-4 font-thin">
          ...
          <li class="mb-4 text-xl">
            ...
            >
              <a href="#" class="block text-xl hover:text-gray-400">Add</a>
          ...
          <li class="mb-4 text-xl">
            ...
            <div v-show="openSubMenu === 'masterlist'" class="mt-2 ml-4 rounded-md p-1">
              ...
              <a href="#" class="block text-xl hover:text-gray-400">Archive</a>
            </div>
          </li>
                  ...
                  >
                    <td class="px-2 py-1 whitespace-nowrap w-1/5">
                      <div class="flex justify-between items-center">
                        ...
                        <a
                          :href="'/municipality/' + municipality.municipalityID"
