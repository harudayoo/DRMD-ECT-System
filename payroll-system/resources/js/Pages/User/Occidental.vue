    ...
    <div class="flex-1 flex flex-col overflow-hidden">
      <header class="flex items-center">
        <div class="ml-1 mt-1 mx-auto py-2 px-4 flex items-center">
          ...
          <div>
            <h1 class="text-2xl font-black text-black">Davao Occidental</h1>
...
const tableData = ref([
  ...
  { municipality: "Malita", beneficiaries: "3,764", amount: "245,235" },
  { municipality: "Santa Maria", beneficiaries: "2,983", amount: "215,064" },
  { municipality: "Sarangani", beneficiaries: "1,870", amount: "211,233" },
]);
  ...
  datasets: [
    {
      ...
      data: [124342, 243545, 124135, 134583, 324657],
    },
    {
      label: "Amount Released",
      backgroundColor: "rgb(166, 170, 238)",
      data: [193454, 294576, 143566, 112456, 126464],
    },
  ],
};
