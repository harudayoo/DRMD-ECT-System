        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <div class="flex-1 flex flex-col overflow-hidden">
                ...
                <div class="flex h-2/6 mx-4 mb-4 -mt-4">
                    <!-- Statistics -->
                    <div
                        class="text-black text-xl -mt-16 shadow-2xl rounded-xl w-1/4 p-2"
                    >
                        <h2
                    ...
                    <!-- Main Content -->
                    <div
                        class="flex-1 border -mt-16 shadow-xl rounded-xl ml-2 p-2"
                    >
                            ...
                            <table class="w-full divide-y divide-gray-200">
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        ></td>
                                        <td
                                            class="px-2 py-2 whitespace-nowrap text-xl font-bold text-right"
                                        >
                                            <span class="mr-20 text-2xl"
                                                >Total</span
                                            >
                                            {{ totalAmount }}
                                        </td>
