<template>
    <div class="h-screen flex flex-col overflow-hidden">
        ...
        <!-- Sidebar -->
        <div
            class="fixed top-0 left-0 h-full w-82 bg-gray-800 bg-opacity-90 text-white transform transition-transform duration-300 ease-in-out z-50 overflow-y-auto"
            :class="{
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <div class="flex-1 flex flex-col overflow-hidden">
                ...
                <div class="flex h-2/6 mx-4 mb-4 -mt-4">
                    <!-- Statistics -->
                    <div class="text-black text-xl -ml-20">
                    ...
                    <!-- Table -->
                    <!-- Table -->
                    <div class="overflow-x-auto rounded-xl ml-14 w-3/4">
                        <table class="min-w-full bg-gray-100">
                            <thead>
                                <tr>
                                    <th class="py-2 px-4 bg-blue-200 text-left">
                                        Province Name
                                    </th>
                                    <th class="py-2 px-4 bg-blue-200 text-left">
                                        Total Beneficiaries
