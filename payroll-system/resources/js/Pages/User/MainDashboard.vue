<template>
  <div class="h-screen flex flex-col overflow-hidden">
    <!-- Top bar -->
    <nav class="bg-sky-900 shadow-2xl flex items-center justify-between px-4 py-1">
      <!-- Menu Toggle Button -->
      <button
        @click="toggleMenu"
      ...
      <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <div class="flex h-2/6 mx-4 mb-4 -mt-4">
          ...
          <div class="text-black text-xl -mt-4 ml-20">
            <div class="font-semibold">Total: <span class="font-black">165</span></div>
            <div class="font-semibold">Pending: <span class="font-black">120</span></div>
            <div class="font-semibold">Approved: <span class="font-black">40</span></div>
          ...
          <div class="overflow-x-auto rounded-xl -mt-14 ml-14 w-3/4">
            <table class="min-w-full bg-gray-100">
              <thead>
                <tr>
                  <th class="py-2 px-4 bg-stone-300 text-left">Province Name</th>
                  <th class="py-2 px-4 bg-stone-300 text-left">Total Beneficiaries</th>
                  <th class="py-2 px-4 bg-stone-300 text-left">Total Amount Released</th>
                </tr>
              </thead>
              <tbody>
                <tr
