<template>
  <div class="h-screen flex flex-col overflow-hidden bg-gray-100">
    <!-- Top navigation bar -->
    <NavBar @toggle-sidebar="toggleSidebar" @toggle-dark-mode="toggleDarkMode" />
    ...
    <div class="flex flex-1 overflow-hidden">
      ...
      <!-- Main content -->
      <main class="flex-1 px-14 -mt-3 overflow-x-hidden overflow-y-auto bg-gray-100">
        <div class="container mx-auto px-6 py-8">
          <h3 class="text-gray-700 text-2xl font-medium">ECT Payroll System Dashboard</h3>
          ...
          <div class="mt-6 flex space-x-4" style="max-height: 280px">
            ...
            <div class="w-full">
              ...
              >
                <h4 class="text-xl font-semibold mb-2">Davao Region</h4>
                <table class="w-full">
                  ...
                  <tbody>
                    <tr
                      ...
                      @click="navigateToMunicipality(row.provinceID, row.provinces)"
                    >
                      <td class="py-2">
...
// Chart configuration
const labels = computed(() => provinces.value.map((province) => province.provinceName));
  ...
  datasets: [
    {
      ...
      data: provinces.value.map((province) => province.totalBeneficiaries),
    },
    {
      label: "Amount Released",
      backgroundColor: "rgb(166, 170, 238)",
      data: provinces.value.map((province) => province.totalAmountReleased),
    },
  ],
}));
