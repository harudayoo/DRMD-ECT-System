<template>
  <div class="h-screen flex flex-col overflow-hidden bg-gray-100">
    ...
    <div class="flex flex-1 overflow-hidden">
      ...
      <!-- Main content -->
      <main class="flex-1 -mt-2 px-14 overflow-x-hidden overflow-y-auto bg-gray-100">
...
const pageTitle = computed(() => {
  return page.props.barangayName || props.barangay?.barangayName || "Beneficiaries";
});
...
onMounted(() => {
  if (!page.props.barangayName && !props.barangay?.barangayName) {
    console.warn("No barangay name provided in page props or component props");
  }
});
</script>
