    ...
    <div class="flex-1 flex flex-col overflow-hidden">
      <header class="flex items-center">
        <div class="ml-1 mt-1 mx-auto py-2 px-4 flex items-center">
          ...
          <div>
            <h1 class="text-2xl font-black text-black">Davao Oriental</h1>
            ...
            <div class="overflow-y-auto flex-grow" style="max-height: 180px">
              <table class="w-full divide-y divide-gray-200">
                <tbody class="bg-white divide-y text-lg font-medium divide-gray-200">
                  <tr v-for="row in tableData" :key="row.municipality">
                    <td class="px-2 py-1 whitespace-nowrap w-1/5">
                      <div class="flex justify-between items-center">
                        ...
                        <a
                          :href="
                            '/municipality/' +
                            row.municipality.toLowerCase().replace(/ /g, '-')
                          "
...
const tableData = ref([
  { municipality: "Baganga", beneficiaries: "1,245", amount: "102,673" },
  { municipality: "Banaybanay", beneficiaries: "1,045", amount: "207,135" },
  { municipality: "Boston", beneficiaries: "3,764", amount: "245,235" },
  { municipality: "Caraga", beneficiaries: "2,983", amount: "215,064" },
  { municipality: "Cateel", beneficiaries: "1,870", amount: "211,233" },
  {
    municipality: "Governor Generoso",
    beneficiaries: "3,513",
    amount: "251,123",
  },
  { municipality: "Lupon", beneficiaries: "2,124", amount: "152,724" },
  { municipality: "Manay", beneficiaries: "2,124", amount: "193,513" },
  { municipality: "Mati", beneficiaries: "1,972", amount: "212,523" },
  { municipality: "San Isidro", beneficiaries: "1,241", amount: "183,523" },
  { municipality: "Tarragona", beneficiaries: "2,870", amount: "251,624" },
]);
